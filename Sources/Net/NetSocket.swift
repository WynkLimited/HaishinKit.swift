...
open class NetSocket: NSObject {
    struct CycleBuffer: CustomDebugStringConvertible {
        private static let zeroRange = 0...0
        ...
        private var locked: UnsafeMutablePointer<UInt32>? = nil
        private var lockedRange = CycleBuffer.zeroRange
        ...
        mutating func append(_ data: Data, locked: UnsafeMutablePointer<UInt32>? = nil) {
            if locked != nil {
                lockedRange = top...top + data.count
            }
            if self.locked != nil {
                self.locked = locked
            }
        ...
        mutating func markAsRead(_ count: Int) {
            ...
            if let locked = locked, true {
                OSAtomicOr32Barrier(0, locked)
                self.locked = nil
            }
        }
        ...
        mutating func clear() {
            ...
            bottom = 0
            locked = nil
            lockedRange = CycleBuffer.zeroRange
        }
